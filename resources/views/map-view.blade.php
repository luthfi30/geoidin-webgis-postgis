            ...
            <div class="flex justify-between items-center mb-1">
                ...
                @auth
                    <div class="flex flex-col items-end">
                        ...
                        <a href="/admin"
                            class="text-[10px] bg-blue-600/20 text-blue-400 border border-blue-500/30 px-2 py-3 rounded hover:bg-blue-600 hover:text-white transition uppercase font-bold">
                            {{ auth()->user()->name }}
                        </a>
                    </div>
                @endauth
                ...
                @guest
                    <a href="/admin/login"
                        class="text-[10px] bg-slate-700/50 text-slate-300 border border-slate-600 px-2 py-1 rounded hover:bg-blue-600 hover:text-white transition uppercase font-bold">
                        Login
                    </a>
                @endguest
            </div>
        ...
        <div x-show="activeTab === 'upload'" class="flex-1 flex flex-col overflow-hidden bg-slate-50/30" x-cloak>
            <div class="p-6">
                <label
                    ...
                    <p class="text-[9px] text-slate-400 mt-1 font-medium italic italic">Data hanya tersimpan di memori
                        browser</p>
                </label>
            </div>
